                   ...
                   LPSTR lpCmdLine, int nCmdShow)
{
    ...
    maps.emplace_back("035 StormwindPrison");
    maps.emplace_back("036 DeadminesInstance");
    maps.emplace_back("037 PVPZone02 (Azshara Crater)");
    maps.emplace_back("042 Collin");
    maps.emplace_back("043 WailingCaverns");
    maps.emplace_back("044 Monastery");
    maps.emplace_back("047 RazorfenKraulInstance");
    maps.emplace_back("048 Blackfathom");
    maps.emplace_back("070 Uldaman");
    maps.emplace_back("090 GnomeragonInstance");
    maps.emplace_back("109 SunkenTemple");
    maps.emplace_back("129 RazorfenDowns");
